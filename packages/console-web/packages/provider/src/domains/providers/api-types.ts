...
export type ProviderOwnerObservabilityItem = {
  ...
  lastProbeRun?: Array<{ surfaceId?: string; timestamp?: string }>;
  lastProbeOutcome?: Array<{ surfaceId?: string; value?: number }>;
  lastProbeReason?: Array<{ surfaceId?: string; reason?: string }>;
  nextProbeAllowed?: Array<{ surfaceId?: string; timestamp?: string }>;
  authUsable?: Array<{ surfaceId?: string; value?: number }>;
  credentialLastUsed?: Array<{ surfaceId?: string; timestamp?: string }>;
  refreshReady?: Array<{ surfaceId?: string; value?: number }>;
  lastRuntimeSeen?: Array<{ surfaceId?: string; timestamp?: string }>;
};
